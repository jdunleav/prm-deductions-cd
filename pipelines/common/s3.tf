...
resource "aws_s3_bucket" "prm-codebuild-gp2gp-adaptor-artifact" {
  bucket        = "prm-${var.caller_identity_current_account_id}-codebuild-gp2gp-adaptor-artifact"
  acl           = "private"
  force_destroy = true
...
resource "aws_s3_bucket" "prm-codebuild-ehr-repo-artifact" {
  bucket        = "prm-${var.caller_identity_current_account_id}-codebuild-ehr-repo-artifact"
  acl           = "private"
  force_destroy = true
