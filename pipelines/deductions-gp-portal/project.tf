...
resource "aws_codebuild_project" "prm-accessibility-gp-portal" {
  name        = "prm-accessibility-gp-portal"
  description = "GP Portal Accessibility"
