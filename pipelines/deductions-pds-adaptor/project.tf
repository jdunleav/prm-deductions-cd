...
resource "aws_codebuild_project" "prm-unit-test-pds-adaptor" {
...
resource "aws_codebuild_project" "prm-dependency-check-pds-adaptor" {
  name        = "prm-dependency-check-pds-adaptor"
  description = "PDS Adaptor Dependency Check"
